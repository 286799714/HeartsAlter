...
只想学习玩法时，可以直接启动 Godot 客户端，在大厅点击“教学关 · 无需联网”，不必启动服务端。三关共 14 个互动步骤，覆盖跟花色、吃墩、认识所有得分牌、缺门优先出分牌、破心、黑桃 Q 翻倍、争第二分奖池、传牌策略和草花 2 先手。操作方式与正式牌桌一致，支持重玩和本地通关记录；教学不影响正式筹码。详见[客户端教学说明](client/README.md#本地教学关)。
